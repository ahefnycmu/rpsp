...
psr_lite.utils.misc.use_matlab_rng()
...
for it in xrange(1000):
    ...
    models['rffrnn'] = rffpsr_rnn.RFFPSR_RNN(models['rffpsr'], optimizer='sgd',
                                             optimizer_iterations=200, optimizer_step=0.1,
    ...
    with open('mse_swimmer_all_mat.pkl', 'wb') as out_file:
        out_file.write(pickle.dumps({'plot_models':plot_models, 'train_time':train_time, 'mse':mse_all}))
