...
from rpsp.rpspnets.psr_lite.noisy_model import NoisyModel
from rpsp.rpspnets.psr_lite.psr_base import structtype
...
class BaseRNNFilter(psr_base.ControlledModel):
    ...
    def train(self, traj_obs, traj_act, traj_act_probs=None, on_unused_input='raise'):
        ...
        nn.minimize_theano_fn(opt_output, opt_inputs,
